...
from options_insights_page import options_insights_page
...
# ========= FILLED OPTIONS TAB =========
with filled_opt_tab:
    options_insights_page()
# ========== FILLED STOCKS TAB ============
filled_stocks = tc.get_orders('STK', datetime.datetime.strptime('2020-01-01', '%Y-%m-%d').date())
filled_stocks_data = [{
